...
describe('Kekulize RDKit Comparison', () => {
  it('should kekulize benzene consistently with RDKit', async () => {
    ...
    const kimchiCounts = getKekuleBondCounts(kekulized.bonds);
    ...
    console.log('  Kimchi:', kimchiCounts);
    console.log('  RDKit:', rdkitCounts);
    
    expect(kimchiCounts.single).toBe(3);
    expect(kimchiCounts.double).toBe(3);
  ...
  it('should kekulize naphthalene consistently with RDKit', async () => {
    ...
    expect(kimchiCounts.single).toBe(6);
    expect(kimchiCounts.double).toBe(5);
  ...
  it('should kekulize furan consistently with RDKit', async () => {
    ...
    expect(kimchiCounts.single).toBe(3);
    expect(kimchiCounts.double).toBe(2);
    expect(rdkitCounts.single).toBe(3);
  ...
  it('should kekulize indole consistently with RDKit', async () => {
    ...
    expect(kimchiCounts.single).toBe(rdkitCounts.single);
    expect(kimchiCounts.double).toBe(rdkitCounts.double);
  });
  ...
  it('should kekulize anthracene consistently with RDKit', async () => {
    ...
    expect(kimchiCounts.single).toBe(9);
    expect(kimchiCounts.double).toBe(7);
  ...
  it('should kekulize phenol consistently with RDKit', async () => {
    ...
    expect(kimchiCounts.single).toBe(4);
    expect(kimchiCounts.double).toBe(3);
