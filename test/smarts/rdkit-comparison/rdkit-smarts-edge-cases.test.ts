...
describe("SMARTS Edge Cases - RDKit Comparison", () => {
  ...
  const testMatch = (smiles: string, smarts: string, description: string, knownDifference?: { openchem: number; rdkit: number; reason: string }) => {
  ...
  describe("Spiro Compounds", () => {
    ...
    testMatch(
      "C1CCC2(CC1)CCCC2",
      "[R2]",
      "Spiro[5.4]decane - R2 atoms"
    );
    testMatch(
      "C12CCC(CC1)CC2",
      "[r5]",
      "Spiro compound - 5-membered rings"
    );
  });
  ...
  describe("Macrocycles", () => {
    testMatch(
      "C1CCCCCCCC1",
      "[R1]",
      "Cyclooctane - R1 atoms"
    );
    testMatch(
      "C1CCCCCCCCCCC1",
      "[r12]",
      "Cyclododecane - r12 ring size"
    );
    testMatch(
      "C1CCCCCCCCCCCCCC1",
      "[r15]",
      "Cyclopentadecane - r15 ring size"
    );
    testMatch(
      "C1CCCCCCCCCCCCCCCCC1",
      "[R1]",
      "Cyclooctadecane - R1 atoms"
    );
  });
  ...
  describe("Mixed Ring Systems", () => {
    testMatch(
      "C1CC2CCCCC2C1",
      "[R1]",
      "Fused 5+6 rings - R1 atoms"
    );
    testMatch(
      "C1CC2CCCCC2C1",
      "[R2]",
      "Fused 5+6 rings - R2 atoms"
    );
    testMatch(
      "C1CCC2(CC1)CCCC2",
      "[R1]",
      "Spiro 6+5 rings - R1 atoms"
    );
    testMatch(
      "C1CCC2(CC1)CCCC2",
      "[R2]",
      "Spiro 6+5 rings - R2 atoms"
    );
  });
  ...
  describe("Edge Cases - Multiple Ring Sizes", () => {
    testMatch(
      ...
      "[r5]",
      "Multiple ring sizes - r5"
    );
    testMatch(
      "C1CCC2CC3CCCCC3CC2C1",
      "[r6]",
      "Multiple ring sizes - r6"
    );
    testMatch(
      "C1CCC2CC3CCCCC3CC2C1",
      "[r7]",
      "Multiple ring sizes - r7"
    );
  });
