...
### Added
- Explicit aromatic bond (`:`) support in SMILES parser
- Morgan fingerprint descriptor (`computeMorganFingerprint`) for molecular similarity and screening
- Comprehensive RDKit validation tests for Morgan fingerprints
